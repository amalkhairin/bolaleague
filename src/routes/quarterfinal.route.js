...
router.get('/draw', (req, res) => {
    let winner = [];
    knex.select('home_team_id').table('Round16').limit(8)
        .then(dataID => {
            knex.select().table('Round16').where(function(){
                                ...
                                .then(match1 => {
                                    ...
                                    knex.select().table('Round16').where(function(){
                                        ...
                                        .then(match1 => {
                                            ...
                                            knex.select().table('Round16').where(function(){
                                                this.where({home_team_id: dataID[4].home_team_id})
                                            }).orWhere({away_team_id:dataID[4].home_team_id})
                                                .then(match1 => {
                                                    // leg 1
                                                    const score1 = parseInt(match1[0].home_score) //home
                                                    const score2 = parseInt(match1[0].away_score) //away
                                                    ...
                                                    knex.select().table('Round16').where(function(){
                                                        this.where({home_team_id: dataID[5].home_team_id})
                                                    }).orWhere({away_team_id:dataID[5].home_team_id})
                                                        .then(match1 => {
                                                            // leg 1
                                                            const score1 = parseInt(match1[0].home_score) //home
                                                            const score2 = parseInt(match1[0].away_score) //away
                                                            ...
                                                            knex.select().table('Round16').where(function(){
                                                                this.where({home_team_id: dataID[6].home_team_id})
                                                            }).orWhere({away_team_id:dataID[6].home_team_id})
                                                                .then(match1 => {
                                                                    // leg 1
                                                                    const score1 = parseInt(match1[0].home_score) //home
                                                                    const score2 = parseInt(match1[0].away_score) //away
                                                                    ...
                                                                    knex.select().table('Round16').where(function(){
                                                                        this.where({home_team_id: dataID[7].home_team_id})
                                                                    }).orWhere({away_team_id:dataID[7].home_team_id})
                                                                        .then(match1 => {
                                                                            // leg 1
                                                                            const score1 = parseInt(match1[0].home_score) //home
                                                                            const score2 = parseInt(match1[0].away_score) //away
                                                                            ...
                                                                            const matches = [
                                                                                {
                                                                                    ...
                                                                                    away_team_id: winner[6].owner_id,
                                                                                    away_team_name: winner[6].team_name,
                                                                                    home_score: "-",
                                                                                    away_score: "-",
                                                                                    is_finished: 0
                                                                                },
                                                                                {
                                                                                    ...
                                                                                    away_team_id: winner[4].owner_id,
                                                                                    away_team_name: winner[4].team_name,
                                                                                    home_score: "-",
                                                                                    away_score: "-",
                                                                                    is_finished: 0
                                                                                },
                                                                                {
                                                                                    ...
                                                                                    away_team_id: winner[5].owner_id,
                                                                                    away_team_name: winner[5].team_name,
                                                                                    home_score: "-",
                                                                                    away_score: "-",
                                                                                    is_finished: 0
                                                                                },
                                                                                {
                                                                                    ...
                                                                                    away_team_id: winner[7].owner_id,
                                                                                    away_team_name: winner[7].team_name,
                                                                                    home_score: "-",
                                                                                    away_score: "-",
                                                                                    is_finished: 0
                                                                                },
                                                                                {
                                                                                    leg: 2,
                                                                                    home_team_id: winner[6].owner_id,
                                                                                    home_team_name: winner[6].team_name,
                                                                                ...
                                                                                {
                                                                                    leg: 2,
                                                                                    home_team_id: winner[4].owner_id,
                                                                                    home_team_name: winner[4].team_name,
                                                                                ...
                                                                                {
                                                                                    leg: 2,
                                                                                    home_team_id: winner[5].owner_id,
                                                                                    home_team_name: winner[5].team_name,
                                                                                ...
                                                                                {
                                                                                    leg: 2,
                                                                                    home_team_id: winner[7].owner_id,
                                                                                    home_team_name: winner[7].team_name,
                                                                            ...
                                                                            knex.insert(rows).into('QuarterFinal')
                                                                                .then(_ => {
                                                                                    res.status(201).send({
                                                                                        success: true,
                                                                                        message: "Quarter-final updated!"
                                                                                    })
                                                                                })
...
router.get('/matches/:leg', (req, res) => {
    ...
    knex.select().table('QuarterFinal').where({leg})
        .then(data => {
            res.status(200).send({
                success: true,
                data
...
router.put('/update', (req, res) => {
    ...
    if (match_id !== undefined && leg !== undefined && home_team_id !== undefined && away_team_id !== undefined && home_score !== undefined && away_score !== undefined && is_finished !== undefined) {
        knex('QuarterFinal').where({match_id, leg}).update({home_score, away_score, is_finished})
            .then(_ => {
                res.send({
                    success: true,
                    message: "Quarter-final updated!"
